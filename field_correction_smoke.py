"""Field-correction smoke — the reviewer edits an extracted value, D3 stages it, D1 gets it.
    ...
    uv run python field_correction_smoke.py
...
from ocr_bifunction.review_repository import SqliteReviewRepository  # noqa: E402
from ocr_bifunction.status import STATUS_DONE, STATUS_NEEDS_REVIEW  # noqa: E402
