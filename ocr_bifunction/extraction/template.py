...
from ocr_bifunction.reading.reader import ProvenanceSpan, TextLine
...
# import straight from `ocr_bifunction.validation.checks`.
from ocr_bifunction.validation.checks import (
    REJECT as REJECT,
    REVIEW as REVIEW,
