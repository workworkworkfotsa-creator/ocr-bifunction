"""Stage ②③ proof — read a document, match a category template, rebuild fields.
    ...
    uv run python -m ocr_bifunction.adapters.extract "inputs/Carte_identité_électronique_française_(2021,_recto).png"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("usage: uv run python -m ocr_bifunction.adapters.extract <document_path>")
        sys.exit(1)
