"""Table adjudication artefact — put the PAGE next to both reconstructions and let a human rule.
    ...
    uv run python proofs/table_adjudication_build.py --go
    uv run python proofs/table_adjudication_build.py --go --limit 2 --max-pages 3
