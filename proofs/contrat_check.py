...
ONE corpus, then retrieve verbatim passages WITH provenance (doc, page).
    ...
    uv run python proofs/contrat_check.py inputs/A.pdf inputs/B.pdf --query "ta question"
    uv run python proofs/contrat_check.py inputs/*.pdf --query "..." --engine embedding
