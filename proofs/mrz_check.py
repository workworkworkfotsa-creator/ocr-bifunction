"""Parse the French legacy MRZ from a CI image and validate its check digits.
    ...
    uv run python proofs/mrz_check.py "inputs/French_Identity_card_1988_-_1994.jpg" [more images...]
...
from ocr_bifunction.extraction.mrz import extract_mrz_lines, icao_check_digit, parse_mrz
