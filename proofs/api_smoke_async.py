"""API async smoke — prove the DOOR + WATCHDOG topology on a real pair (no llama).
    ...
    uv run python proofs/api_smoke_async.py <recto_image> <verso_image> [--document-type carte_identite]
...
from ocr_bifunction.adapters.api_maquette import app  # noqa: E402
