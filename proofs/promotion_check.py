"""D3 -> D2 promotion runner — prove the organic-growth loop end to end (deterministic, no llama).
    ...
    uv run python proofs/promotion_check.py <doc> [--held-out facture_entrante_03] [--store PATH]
...
from ocr_bifunction.storage.repository import STATUS_NEEDS_REVIEW, Job, SqliteRepository
