"""Image-dominance observer — how many pages does the text-layer gate read BLIND?
    ...
    uv run python proofs/image_dominance_observer_run.py
    uv run python proofs/image_dominance_observer_run.py --inputs inputs/SOP --names
...
from ocr_bifunction.reading.reader import TEXT_LAYER_MINIMUM_CHARACTERS
