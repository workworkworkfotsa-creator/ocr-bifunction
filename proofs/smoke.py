...
boxes that stage ③ will anchor on are inspectable.
    ...
    uv run python proofs/smoke.py            # reads inputs/, OCR on
    uv run python proofs/smoke.py some/dir   # reads some/dir
    uv run python proofs/smoke.py --no-ocr   # text layer only, skip OCR
"""
...
from ocr_bifunction.reading.reader import OcrEngine, ReadResult, read_document
