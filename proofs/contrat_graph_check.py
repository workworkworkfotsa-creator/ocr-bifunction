...
referenced contract corpus, then answer a query with a 1-HOP TRAVERSAL, not just retrieval.
    ...
    uv run python proofs/contrat_graph_check.py inputs/A.pdf inputs/B.pdf --query "que modifie l'avenant 7"
...
from ocr_bifunction.knowledge.generation import LlamaSwapGenerator, Reference
...
from ocr_bifunction.knowledge.reference_graph import (
    ReferenceEdge,
