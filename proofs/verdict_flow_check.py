...
Run from the project root: uv run python proofs/verdict_flow_check.py
"""
...
from ocr_bifunction.flow.orchestrator import BatchItem, DocumentRecord, process_batch
from ocr_bifunction.storage.repository import STATUS_DONE, STATUS_REJECTED
